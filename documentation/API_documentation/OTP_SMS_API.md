...
| ----------------------------------------------- |
| curl -X 'POST' `https://sample-base-url/one-time-password-sms/v0/send-code`   <br>    -H 'accept: application/json' <br>    -H 'Content-Type: application/json'<br>    -H "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbG...."<br>    -d '{ "phoneNumber": "+346661113334", <br> "message": "{{code}} is your short code to authenticate with Cool App via SMS"}'  |
